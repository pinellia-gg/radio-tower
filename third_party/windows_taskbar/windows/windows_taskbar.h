...
class WindowsTaskbar {
 public:
  ...
  // A new TaskbarButtonCreated message is sent after Explorer restarts. The
  // thumbnail buttons must be added again instead of updated in that case.
  void ResetThumbnailToolbarRegistration();
